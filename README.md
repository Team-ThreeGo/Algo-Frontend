...
| 배태용 | 백엔드 때와 마찬가지로 태용님은 스터디 관련 페이지를 담당하셨습니다. 페이지 수도 많고 직접 구현해야 하는 컴포넌트도 많았음에도 지친 내색 없이 밤새워살도도 끝까지 완성해주셨습니다. 심지어 맡은 작업을 모두 끝낸 뒤에도 남은 페이지들을 먼저 나서서 만들어주시는 모습이 굉장히 인상 깊었고 그런 모습을 보면서 본받고 싶었습니다. 태용님 덕분에 피그마 설계 그대로 예쁜 사이트를 만들 수 있었습니다. 발표도 멋지게 해주셨고 같이 프로젝트를 할 수 있어서 좋았습니다! |
...
| 허창훈 | 창훈님과 함께 에러를 찾아서 해결하는 과정이 정말 재밌었습니다. 덕분에 저도 오류 잡으면서 많이 배울 수 있었습니다. 시간이 촉박한 상황에서도 발표 직전까지 밤새워서 어려운 등급업 팝업창 기능을 끝까지 설계해주시는 모습이 인상깊었습니다. 창훈님의 열정적인 태도로 저 역시 더 열심히 개발할 수 있었습니다. 또 프로젝트의 캐릭터인 코알라 이미지를 다양하게 만들어 주셔서 프로젝트 하느라 지친 일상에 큰 힘이 되었습니다. 창훈님 덕분에 재밌게 프로젝트 진행할 수 있어서 감사했습니다~코! |
